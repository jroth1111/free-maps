...
Free Maps depends on and redistributes assets from the following projects. Their own licenses continue to apply.

- MapLibre GL JS — BSD-3-Clause
- PMTiles — BSD-3-Clause
- Protomaps Basemaps and basemap assets — BSD-3-Clause
- OpenStreetMap data — Open Database License; attribution is rendered on every basemap
- Lit — BSD-3-Clause
- React (optional integration/demo dependency) — MIT
